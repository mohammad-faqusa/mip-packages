const peripherals = [
  {
    ...
    attributes: {
      simulate: {
        ...
        purpose:
          "Determines whether the sensor operates in simulation or real hardware mode",
      },
      addr: {
        dataType: "Number",
        format: "hex",
    ...
    methods: {
      ...
      read_all: {
        ...
        purpose:
          "Returns both accelerometer and gyroscope readings in one call",
      },
    },
  },
  {
    ...
    attributes: {
      ...
      _temp: {
        ...
        default: 0,
        purpose:
          "Latest measured temperature value. Valid range: -40°C to 125°C",
      },
      _humidity: {
        dataType: "Number",
        unit: "%",
    ...
    methods: {
      measure: {
        returns: "void",
        purpose:
          "Triggers the sensor to update temperature and humidity readings",
      },
      temperature: {
        returns: {
          dataType: "Number",
        ...
        purpose:
          "Returns the last measured temperature value. Range: -40°C to 125°C",
      },
      humidity: {
        returns: {
          dataType: "Number",
  ...
  },
  {
    ...
    attributes: {
      ...
      simulate: {
        ...
        purpose:
          "Determines whether encoder is in simulation or real hardware mode",
      },
      _position: {
        dataType: "Number",
        access: "read-only",
        ...
        default: 0,
        purpose:
          "Current position of the encoder (increments/decrements on rotation)",
      },
    },
    methods: {
      get_position: {
      ...
      simulate_step: {
        parameters: {
          steps: {
            dataType: "Number",
            purpose:
              "Number of steps to increment or decrement position (for simulate mode)",
          },
        },
        returns: "void",
  ...
  },
  {
    ...
    attributes: {
      ...
      analog: {
        ...
        purpose:
          "Specifies whether the sensor is working in analog or digital mode",
      },
      simulate: {
        dataType: "Boolean",
        default: true,
      ...
      _gas_level: {
        ...
        default: 0,
        purpose:
          "Latest gas level reading. Range: 0 to 1023 (for analog mode) or 0/1 (for digital mode)",
      },
    },
    methods: {
      read: {
        ...
        purpose:
          "Reads the current gas level from the sensor. Range: 0 to 1023 (analog) or 0/1 (digital)",
      },
    },
  },
  {
  ...
  },
  {
    ...
    attributes: {
      simulate: {
        ...
        purpose:
          "Controls whether the internal LED operates in simulation or real mode",
      },
    },
    methods: {
      on: {
      ...
      is_on: {
        ...
        purpose:
          "Returns the current state of the internal LED (True if ON, False if OFF)",
      },
    },
  },
  {
  ...
  },
  {
    ...
    attributes: {
      ...
      simulate: {
        ...
        purpose:
          "Controls whether the button operates in simulation or real mode",
      },
      debounce_ms: {
        dataType: "Number",
        default: 50,
        ...
        purpose:
          "Debounce time in milliseconds to prevent false triggering from button presses",
      },
      _last_state: {
        dataType: "Boolean",
        access: "read-only",
        purpose:
          "Stores the last known state of the button (True = pressed, False = released)",
      },
      _last_time: {
        dataType: "Number",
        access: "read-only",
      ...
      _simulated_state: {
        ...
        access: "read/write",
        purpose:
          "Used only in simulation mode to manually control the button state",
      },
      was_pressed: {
        dataType: "Boolean",
        access: "read-only",
        purpose:
          "Indicates whether the button was pressed (can be used to detect button press events)",
      },
    },
    methods: {
      set_simulated_state: {
        parameters: {
          pressed: {
            ...
            purpose:
              "Sets the simulated state of the button (only used in simulation mode)",
          },
        },
        returns: "void",
      ...
      is_pressed: {
        ...
        purpose:
          "Checks if the button is pressed or released, applies debounce logic",
      },
      push: {
        returns: "void",
        purpose:
          "Simulates a button press and release cycle (only for simulation mode)",
      },
      get_event: {
        returns: {
          dataType: "Boolean",
        ...
        purpose:
          "Returns and clears the `was_pressed` flag indicating whether the button was pressed",
      },
    },
  },
  {
    ...
    attributes: {
      ...
      active_high: {
        ...
        purpose:
          "Defines whether the relay is activated when the pin is HIGH or LOW",
      },
      simulate: {
        dataType: "Boolean",
        default: true,
    ...
    methods: {
      on: {
        returns: "void",
        purpose:
          "Turns the relay ON (sets pin to HIGH or LOW based on active_high)",
      },
      off: {
        returns: "void",
        purpose:
          "Turns the relay OFF (sets pin to LOW or HIGH based on active_high)",
      },
      toggle: {
        returns: "void",
      ...
      is_on: {
        ...
        purpose:
          "Returns the current state of the relay (True if ON, False if OFF)",
      },
    },
  },
  {
    ...
    attributes: {
      ...
      _pulse_us: {
        ...
        access: "read-only",
        purpose:
          "Current pulse width in microseconds corresponding to the angle",
      },
    },
    methods: {
      write_angle: {
        ...
        parameters: {
          angle: {
            ...
            unit: "°",
            purpose:
              "Sets the servo motor to a specific angle, from 0° to 180°",
          },
        },
        purpose:
          "Sets the servo motor's angle by calculating the corresponding pulse width",
      },
      write_us: {
        returns: "void",
        parameters: {
          us: {
            ...
            unit: "μs",
            purpose:
              "Sets the servo motor's pulse width directly in microseconds",
          },
        },
        purpose:
          "Sets the servo motor's pulse width directly in microseconds and updates the angle",
      },
      get_state: {
        returns: {
          dataType: "Object",
        ...
        purpose:
          "Returns the current state of the servo motor including pin, angle, and pulse width",
      },
      deinit: {
        returns: "void",
  ...
  },
  {
    ...
    attributes: {
      ...
      simulate: {
        ...
        purpose:
          "Controls whether the switch operates in simulation or real mode",
      },
      _state: {
        dataType: "Boolean",
        default: false,
    ...
    methods: {
      ...
      read: {
        ...
        purpose:
          "Reads the current switch state (either simulated or from the actual pin)",
      },
      state: {
        returns: {
          dataType: "Boolean",
